    ...
    NoteType(
        ...
        properties=(
            ...
            NotionProperty(
                ...
                "Если в тексте режиссёр не назван, но фильм узнаваем по названию — "
                "заполни сам, используя свои знания о фильме. Оставляй пустым "
                "только если фильм не получается надёжно идентифицировать.",
            ),
            NotionProperty(
                "Year",
                "rich_text",
                "Год выхода фильма (4 цифры, например '1999'). Если год не назван "
                "в тексте, но фильм узнаваем по названию — заполни сам, используя "
                "свои знания. Оставляй пустым только если фильм не получается "
            ...
            NotionProperty(
                "Country",
                "rich_text",
                "Страна(ы) производства фильма (например 'США' или "
                "'США, Великобритания'). Может быть пустым (дозаполнится "
